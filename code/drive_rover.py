...
class RoverState():
    def __init__(self):
        ...
        self.go_sample = 50 # Threshold to go for the rock sample
        ...
        # keep the yaw angle when entering stop mode
        self.entering_stop = True
        self.stop_init_yaw = 0.0

        # Counter for detecting if we are stuck. The threshold should be changed according to FPS.
        self.stuck_thres = 30
        self.stuck_count = 0

        # Define stop velocity for this rover
        self.stop_velocity_thresh = 0.2

        # Define camera vision for decision step
        self.camera_vision = 15.0
